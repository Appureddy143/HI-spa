...
<head>
  ...
  <style>
    :root{
      --bg:#f8fafc; --text:#1f2937; --muted:#6b7280; --accent:#166534; --card:#ffffff;
      --glass: rgba(255,255,255,0.75);
    }
    .dark{
      --bg:#0b1220; --text:#e6eef6; --muted:#94a3b8; --accent:#4ade80; --card:#0f1724; --glass: rgba(15,23,36,0.6);
    }
    ...
    *{box-sizing:border-box}
    ...
    .hero-card{
      max-width:920px;background:rgba(0,0,0,0.45);padding:48px;border-radius:14px;color:white;text-align:center;backdrop-filter: blur(2px);
    ...
    .card{background:var(--card);border-radius:12px;overflow:hidden;box-shadow:0 6px 20px rgba(2,6,23,0.06)}
    ...
    input[type="text"], input[type="email"], input[type="date"], input[type="time"], select{
      padding:10px;border-radius:8px;border:1px solid #e6e7eb;background:transparent;color:var(--text)
    }

    /* Footer */
    footer{padding:40px 0;text-align:center;background:transparent}
    ...
    .spinner{width:96px;height:96px;border-radius:50%;display:inline-block;position:relative;box-shadow:inset 0 0 0 6px rgba(22,101,52,0.1)}
    ...
    <div class="container">
      ...
      <div class="grid services-grid">
        ...
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1512290923902-8a9f31c83659?q=80&w=2070&auto=format&fit=crop" alt="Swedish Massage">
          <div class="card-body">
        ...
        <!-- card 2 -->
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=2070&auto=format&fit=crop" alt="Aromatherapy">
          <div class="card-body">
            <h3>Aromatherapy</h3>
        ...
        <!-- card 3 -->
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1519823551278-64ac92734fb1?q=80&w=1974&auto=format&fit=crop" alt="Hot Stone Therapy">
          <div class="card-body">
        ...
        <!-- card 4 -->
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=2070&auto=format&fit=crop" alt="Deep Tissue Massage">
          <div class="card-body">
        ...
        <!-- card 5 -->
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=2070&auto=format&fit=crop" alt="Rejuvenating Facial">
          <div class="card-body">
        ...
        <!-- card 6 -->
        <article class="card reveal">
          <img src="https://images.unsplash.com/photo-1552693673-1bf958298935?q=80&w=2070&auto=format&fit=crop" alt="Couples Package">
          <div class="card-body">
